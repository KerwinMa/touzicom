...
class api extends Base {
    ...
    public function code2Action() {
           ...
           $dianhua=  $this->post('phone');
 
          $suijishu=  rand(1000, 9999);
              
            session::set('suijishu', $suijishu);
              
             
           $iscode= $this->sendSMS ($dianhua, $suijishu);
             
           
             /*return   $iscode;*/
             
    // if($iscode==1)return 1; 
	}

	public function indexAction() {

	    echo '本程序由：上海诗智网络科技有限公司提供<br/>程序版本：' . XIAOCMS_RELEASE . '<br/>官方网站：<a href="http://www.shshizhi.com" >http://www.shshizhi.com</a>';
